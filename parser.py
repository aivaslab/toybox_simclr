...
def get_parser(desc):
    ...
    parser.add_argument('--distort', '-d', choices=['self', 'object', 'transform', 'class'],
                        help="Choose distortion for images. "
                             "self for augmentations, "
                             "object for other view of same object, "
                             "transform for other image of object from same video, "
                             "class for image from any other"
                             "frame of same class.")
